...
import com.phvalt.amcws.imageutils.LazyAdapter;
...
public class MainActivity extends Activity {
	...
	public class AsyncCallWS extends AsyncTask<Void, Integer, Boolean >{
		...
		protected void onProgressUpdate(Integer... index) {
			...
			tryResult.setText(index[0] + " objects trouvés");
		}
		
		protected void onPostExecute(Boolean param){
			if(param){
				tryResult.append(" et c'est fini");
	...
	public void startDisplayActivity() {
		...
		Intent i = new Intent(MainActivity.this, ShowProductListActivity.class);
	    i.putParcelableArrayListExtra("listeResult",fullResponse);
	    startActivity(i);
	}
